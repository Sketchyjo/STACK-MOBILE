...
export const Header = ({ title, subtitle, leftIcon, rightIcon, onLeftPress, onRightPress, showBackButton = false, backgroundColor = colors.background.main, className, }) => {
    return (_jsx(SafeAreaView, { style: { backgroundColor }, children: _jsxs(View, { className: `
          ...
          ${className || ''}
        `, style: { backgroundColor }, children: [_jsxs(View, { className: "flex-row items-center flex-1", children: [(leftIcon || showBackButton) && (_jsx(TouchableOpacity, { onPress: onLeftPress, className: "mr-3 p-2 -ml-2", accessibilityRole: "button", accessibilityLabel: showBackButton ? 'Go back' : 'Left action', children: leftIcon || (showBackButton && (_jsx(Text, { className: "text-[#000000] text-lg", children: "\u2190" }))) })), _jsxs(View, { className: "flex-1", children: [_jsx(Text, { className: "text-[#000000] text-lg font-bold", style: {
